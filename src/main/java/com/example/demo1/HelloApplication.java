...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlStatistic = new FXMLLoader(HelloApplication.class.getResource("statistic-view.fxml"));
        Scene statScene = new Scene(fxmlStatistic.load());
        stage1.setTitle("Hello!");
        stage1.setScene(statScene);
        stage1.show();
    }
